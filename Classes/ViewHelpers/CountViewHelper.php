...
/*                                                                        *
 * This script is based on the FLOW3 package "Fluid".                     *
 *                                                                        *
 ...
 * <imprint:count subject="{0:1, 1:2, 2:3, 3:4}" />
 * </code>
 * <output>
 * 4
 * </output>
 ...
 * @api
 */
class Tx_Imprint_ViewHelpers_CountViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {

	/**
	 * Counts the items of a given property.
	 *
	 * @param mixed $subject The array or ObjectStorage to iterated over
